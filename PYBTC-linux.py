...
# Linux-friendly file paths
api_json_path = 'api.json'
private_key_json_path = 'private_key.json'
wallet_json_path = 'wallet.json'
info_png_path = 'info.png'
generate_png_path = 'generate.png'
send_png_path = 'send.png'
wallet_png_path = 'wallet.png'
key_png_path = 'key.png'
web_png_path = 'web.png'
...
# Load private key
with open(private_key_json_path, 'r') as f:
...
# Set the window icon
icon = tk.PhotoImage(file=info_png_path)
...
# Load the images
imagee = tk.PhotoImage(file=generate_png_path)
imager = tk.PhotoImage(file=send_png_path)
imaget = tk.PhotoImage(file=wallet_png_path)
imagetw = tk.PhotoImage(file=key_png_path)
imagepw = tk.PhotoImage(file=web_png_path)
